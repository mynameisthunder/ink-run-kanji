...
import { BUNDLED_AUDIO_ITEMS, DECKS, KANJI, KANJI_BY_WORD, itemKey } from "../src/vocabulary.js?v=n2-1";
...
function useHint() {
  ...
  playTone("wrong");
  renderEnemy({ preserveFeedback: true });
  setFeedback("Hint used. Recorded as a miss; the enemy returns later.", "miss");
  animate("is-hurt", elements.battle);
  if (dungeon.status !== "playing") renderEnd();
}
